...
-- Container dan scroll untuk menu sidebar
local MenuContainer = Instance.new("Frame")
MenuContainer.Name = "MenuContainer"
MenuContainer.Size = UDim2.new(1, 0, 1, -120) -- Sisakan ruang atas & bawah
MenuContainer.Position = UDim2.new(0, 0, 0, 60)
MenuContainer.BackgroundTransparency = 1
MenuContainer.Parent = Sidebar

local MenuScroll = Instance.new("UIScrollBar")
...
for i, menu in ipairs(menuData) do
    ...
    btn.MouseButton1Click:Connect(function()
        selectedMenu = i
        for j, child in ipairs(MenuContainer:GetChildren()) do
